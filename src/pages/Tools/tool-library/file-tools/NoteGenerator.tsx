      ...
      <main className="px-6 py-10 max-w-xl mx-auto space-y-8">
        ...
        <div className="bg-[#141414] border border-white/5 p-6 rounded-3xl space-y-3 relative overflow-hidden">
          ...
          <p className="text-sm text-white/60 leading-relaxed">
            এই জেনারেটর টুলটি দিয়ে আপনি এক ক্লিকে হাজার হাজার বাংলা ও ইংরেজি নোট তৈরি করতে পারবেন। প্রতিটি নোটে আপনার দেওয়া ট্যাগ সংখ্যা অনুযায়ী ট্যাগ যোগ করা হবে। এর সাহায্যে আমাদের নতুন <strong>RCST (Redwan Content Search Technology)</strong> সার্চের স্পিড, মেমোরি দক্ষতা এবং ১০ জিবি থেকে ৪০ জিবির স্কেল হ্যান্ডেলিং ক্ষমতা নিখুঁতভাবে পরীক্ষা করতে পারবেন।
          </p>
        </div>
