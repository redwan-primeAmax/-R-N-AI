    ...
    <div className="mb-10 overflow-hidden mt-8">
      ...
      <div className="flex gap-3 overflow-x-auto px-5 no-scrollbar pb-4 -mx-1">
        {notes.map(note => (
          ...
          >
            <div className="w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center text-3xl shadow-inner border border-white/10 border-b-[2px] border-r-[1px]">
              {note.emoji || '📝'}
            </div>
