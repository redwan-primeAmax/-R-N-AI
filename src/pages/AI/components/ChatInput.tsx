...
export const ChatInput: React.FC<InputAreaProps> = ({
  ...
  return (
    <div className="p-4 bg-[#0d0d0d] border-t border-white/5 sticky bottom-0 z-40 pb-safe-area-inset-bottom">
        ...
        <div className="relative group flex items-center gap-3">
          ...
          <div className="relative flex-grow">
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center text-white/40 hover:text-white disabled:opacity-20 transition-all active:scale-95"
            >
